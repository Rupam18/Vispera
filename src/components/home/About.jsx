...
export default function About() {
  return (
    <section id="about" className="bg-bg-light overflow-hidden relative">
      ...
      <div className="flex flex-col lg:flex-row items-center relative z-10 py-12 md:py-16">
        ...
        <motion.div
          ...
          className="w-full lg:w-[42%] flex-shrink-0 mb-12 lg:mb-0"
        >
        ...
        {/* ── Right Content Area ── */}
        <div className="container-custom lg:ml-0 lg:flex-grow flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="max-w-xl">
              {/* Quote */}
              <p className="text-4xl md:text-5xl font-semibold leading-tight text-[#0A374C]">
              ...
              {/* Subheading */}
              <p className="mt-8 font-bold text-[#0A374C] text-sm md:text-base leading-relaxed tracking-wide uppercase font-heading">
              ...
              {/* Description */}
              <p className="mt-6 text-gray-400 leading-relaxed text-[13px] md:text-sm font-light">
              ...
              {/* Button */}
              <button className="mt-8 px-8 py-3 bg-[#5EA4A4] text-white rounded-lg shadow-lg hover:bg-[#4D9090] transition-all transform hover:scale-105 active:scale-95">
                Learn More
              </button>
            </div>
          </motion.div>
